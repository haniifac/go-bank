...
const file_service_simple_bank_proto_rawDesc = "" +
	"\n" +
	"\x19service_simple_bank.proto\x12\x02pb\x1a\x1cgoogle/api/annotations.proto\x1a.protoc-gen-openapiv2/options/annotations.proto\x1a\x15rpc_create_user.proto\x1a\x14rpc_login_user.proto2\x8c\x03\n" +
	"\n" +
	"SimpleBank\x12\x8c\x01\n" +
	"\n" +
	"CreateUser\x12\x15.pb.CreateUserRequest\x1a\x16.pb.CreateUserResponse\"O\x92A5\x12\x11Create a new user\x1a An endpoint to create a new user\x82\xd3\xe4\x93\x02\x11:\x01*\"\f/v1/register\x12\xee\x01\n" +
	"\tLoginUser\x12\x14.pb.LoginUserRequest\x1a\x15.pb.LoginUserResponse\"\xb3\x01\x92A\x9b\x01\x12\x1dLogin user and receive tokens\x1azAn endpoint to login using username and password from registered user. Client will receive access token and refresh token.\x82\xd3\xe4\x93\x02\x0e:\x01*\"\t/v1/loginB#Z!github.com/haniifac/simplebank/pbb\x06proto3"
